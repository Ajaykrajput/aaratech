...
const AshramContact = () => {
  return (
    <div className="flex md:flex-row flex-col mt-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 w-full gap-1">
        {ashramContect.map((ashram) => (
          ...
          >
            ...
            <div className="flex py-1 text-center w-full">
              <PhoneCall className="w-5 h-5 ml-10 text-orange-500 fill-orange-500" />
              <h1 className="text-xs font-medium ml-12">{ashram.contact}</h1>
            </div>
            <div className="flex py-1 text-center w-full">
              <MailCheckIcon className="w-5 h-5 ml-10 text-orange-500 fill-orange-500" />
              <h1 className="text-xs font-medium ml-12">{ashram.email}</h1>
            </div>

            <div className="flex justify-around py-1 text-center w-full">
              <button
                type="button"
              ...
              <img src={ashram.image} alt={ashram.alt} className="w-32 h-24" />
            </div>
          </div>
        ))}
      </div>
