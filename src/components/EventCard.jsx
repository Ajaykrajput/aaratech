...
const EventCard = () => {
  ...
  echo "# aaratech" >> README.md
git init
git add README.md
git commit -m "first commit"
git branch -M main
git remote add origin https://github.com/Ajaykrajput/aaratech.git
    ...
    <>
      <div className="fixed bottom-48 right-0 bg-gradient-to-tl from-[#a5ecd8] to-orange-400 p-4 rounded-lg shadow-lg max-w-[180px] cursor-pointer w-full z-20">
        ...
        <div className="flex justify-between w-full py-1">
          ...
          <ChevronDown
            className="w-4 h-4 ml-auto fill-black cursor-pointer"
        ...
        {openEvent && (
          <div
            ref={eventDetailsRef}
            className="fixed bottom-64 right-0 rounded-xl max-w-2xl w-full z-50 shadow-[0_0_15px_5px_rgba(255,165,0,0.9)]"
          >
            <table className="min-w-full text-sm rounded-l-md text-gray-800 text-center bg-orange-300 p-4">
              ...
              <tbody>
                <tr className="hover:bg-white hover:z-50 hover:shadow-amber-50 shadow-2xll">
